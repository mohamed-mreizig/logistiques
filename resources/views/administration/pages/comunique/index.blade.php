...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">{{ __('Modifier le communiqué') }}</h2>
        </div>
        ...
        <div class="p-6">
            ...
            <form method="post" action="{{ url('comunique/' . ($mission?->id ?? 'new') . '/mission') }}" 
                ...
                <div class="flex items-center gap-4">
                    ...
                    @if (session('status') === 'communique-updated')
