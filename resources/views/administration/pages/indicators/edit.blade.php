...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Modifier l'indicateur</h2>
        ...
        <div class="p-6">
            <form action="{{ route('indicators.update', $indicator) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Titre</label>
                    <input type="text" name="title" value="{{ old('title', $indicator->title) }}"
                ...
                <div>
                    ...
                    <input type="number" name="value" value="{{ old('value', $indicator->value) }}"
                ...
                <div>
                    ...
                    <input type="text" name="icon" value="{{ old('icon', $indicator->icon) }}"
                ...
                <div>
                    ...
                    <input type="text" name="categorie" value="{{ old('categorie', $indicator->categorie) }}"
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="is_published" name="is_published" 
                           ...
                           {{ $indicator->is_published ? 'checked' : '' }}>
                    <label for="is_published" class="ml-2 block text-sm text-gray-700">Publié</label>
                </div>
