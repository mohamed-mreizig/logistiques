...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Modifier le type</h2>
        ...
        <div class="p-6">
            <form action="{{ url('servicetad/'.$type->id) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')

                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Type de service</label>
                    <input type="text" name="name" id="name" value="{{ $type->type }}"
