                ...
                <div class="row my-4">
                    <div class="col-md-12 text-center">
                        <h1 class="event-title text-left" style="font-family: 'Inter'; font-weight: bold;opacity:1;">
                            {{ app()->getLocale() === 'ar' ? $projet->titleAr : $projet->titleFr }}
                        </h1>
                        {{-- <p class="text-muted" style="font-size: 14px; font-family: 'Inter';">
                {{ \Carbon\Carbon::parse($event->start_at)->format('l, F d, Y') }} 
                - 
                {{ \Carbon\Carbon::parse($event->ends_at)->format('l, F d, Y') }}
            </p> --}}
                    </div>
                </div>
                ...
                <div class="">
                    ...
                    <div class="col-md-12">
                        <div class="image-section" style="overflow: hidden; border-radius: 10px;">
                            <img src="{{ s3Asset($projet->imgUrl) }}" alt="Event Image" class="img-fluid"
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <!-- Event Title -->
                            <p class="text-muted" style="font-size: 14px; font-family: 'Inter';">
                                {{ \Carbon\Carbon::parse($projet->start_at)->locale('fr')->isoFormat('dddd D MMMM YYYY') }}
                                -
                                {{ \Carbon\Carbon::parse($projet->ends_at)->locale('fr')->isoFormat('dddd D MMMM YYYY') }}
                            </p>
                            ...
                            <p class="event-description"
                                ...
                                {!! app()->getLocale() === 'ar'
                                    ? $projet->descriptionAr
                                    : preg_replace('/<div[^>]*>|<\/div>/', '', $projet->descriptionFR) !!}
                            </p>
