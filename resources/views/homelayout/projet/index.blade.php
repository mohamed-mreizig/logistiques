...
@section('content')
    <div class="container">
        <h2 class="texte">{{ __('messages.project_management') }}</h2>
...
;
    ...
    margin-bottom: 90px;">
                ...
                <div class="container mb-4">
                                    ...
                                    <div class="card" style="border: none; background-color: transparent;">
                                        ...
                                        <div class="text-section mt-2">
                                            ...
                                            {{-- <p style="font-size: 10px; font-family: 'Inter'; font-weight: 300;">
                                                    {{ \Carbon\Carbon::parse($projet->start_at)->format('l, F d, Y') }} 
                                                    - 
                                                    {{ \Carbon\Carbon::parse($projet->ends_at)->format('l, F d, Y') }}
                                                </p> --}}
                                            <p class="snippet" style="font-size: 12px; font-family: 'Inter'; ">
                                                {!! app()->getLocale() === 'ar'
                                                    ? Str::limit( preg_replace('/<div[^>]*>|<\/div>/', '',  $projet->descriptionAr),100)
                                                    : Str::limit( preg_replace('/<div[^>]*>|<\/div>/', '', $projet->descriptionFR),100) !!}
                                            </p>
                    ...
                    @else
                        <p>{{ __('messages.no_projects_available') }}</p>
                    @endif
